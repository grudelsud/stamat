 ...
 *
 */
public class TopicDetectionAnalyser extends AbstractAnalyser {
	...
	public Vector<SemanticKeyword> process(HttpServletRequest request,
		...
		if (getModelLDACheckboxParameter(request).equals(HomerConstants.MODELLDA)){
			
			//String url_db = request.getParameter(HomerConstants.POSTPAR_DBURL);
			//String db = request.getParameter(HomerConstants.POSTPAR_DBNAME);
			//String user_db = request.getParameter(HomerConstants.POSTPAR_DBUSER);
			//String password_db = request.getParameter(HomerConstants.POSTPAR_DBPWD);
...
//	}
	...
	protected String getModelLDACheckboxParameter(HttpServletRequest request){
		try {
			String modelLDA = request.getParameter(HomerConstants.POSTPAR_MODELLDA);
			if (modelLDA==null) modelLDA = "";
			return modelLDA;
		} catch (Exception e) {
			return HomerConstants.DEFAULT_MODELLDA;
		}
	}
